...
import dp from "./assets/cat-kolbasa.png";
            ...
            <main data-state={backgroundColor ? "active" : ""}>
                    ...
                    >
                        <div className="flex-mobile">
                            ...
                            <div className="about-txt">
                                <p>
                                    <br />I enjoy building scalable frontend
                                    design systems in React with modern
                                    aesthetics, well-thought-out structure, and
                                    seamless interactions. I love creating
                                    innovative solutions and continuously
                                    improving the user experience, pushing the
                                    boundaries of what’s possible in web
                                    development.
                                </p>
                            </div>
                        </div>
                ...
                <section className="section-projects">
                    <div className="container">
                        ...
                        >
                            <a
                                href="https://creative-agency-website-version-2.vercel.app/"
                                title="Github Repo"
                                target="_blank"
                                className="portfolio-block-1"
                                onMouseEnter={() => setPortfolioImg("Admin")}
                            >
                            ...
                            <a
                                href="https://eeoneget.github.io/e-sense/"
                                title="live site"
                                target="_blank"
                                className="portfolio-block-1"
                                onMouseEnter={() => setPortfolioImg("Canva")}
                            >
                            ...
                            <a
                                href="https://rms-demo.vercel.app/"
                                title="live site"
                                target="_blank"
                                className="portfolio-block-1"
                                onMouseEnter={() => setPortfolioImg("jobPage")}
                            >
                            ...
                            <div
                                className="portfolio-block-1 important"
                                onMouseEnter={() => setPortfolioImg("admin")}
                            >
